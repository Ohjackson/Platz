...
#### 데이터 소스
- `lessons.json` - A1/A2에 걸친 30개 구조화된 레슨
- `dialogs.json` - A1/A2에 걸친 17개 회화 시나리오
- `quizzes.json` - 설명이 포함된 33개 퀴즈
...
│   ├── lessons.json       # 30개 언어 학습 레슨
│   ├── dialogs.json       # 17개 회화 시나리오
│   ├── quizzes.json       # 33개 퀴즈 세트
...
- A2 레슨 14개: Perfekt, 조동사, 부문장, 분리동사, 장소/방향 전치사, 비교급, 재귀동사, 형용사 어미, zu Infinitiv, wenn 조건문, 실전 회화
...
- A2 대화 7개: 약속 시간 변경, 병원 예약, 집 문제 설명, 주문 확인, 기차 지연, 물건 교환, 관공서 예약
